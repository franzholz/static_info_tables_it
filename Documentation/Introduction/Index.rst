...
This extension provides Italian translations for the country, country subdivision, currency, language and territory records of static_info_tables.
For this purpose, it adds one or two fields to those tables and fills them with Italian data, if available.
...
.. figure:: /Images/RecordView.png
	...
	Record view of the "Italian" country record with new field "Short name (IT)" filled with the Italian translation.
