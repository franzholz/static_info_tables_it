# -*- coding: utf-8 -*-
#
# Static Info Tables (it) documentation build configuration file, created by
# TYPO3 extension sphinx on Tue, 20 Oct 2015 13:04:19 +0200.
#
...
project = u'Static Info Tables (it)'
copyright = u'2015, Franz Holzinger'
...
htmlhelp_basename = 'static_info_tables_itdoc'
...
latex_documents = [
    ('Index', 'static_info_tables_it.tex', u'Static Info Tables (it)',
     u'Franz Holzinger', 'manual'),
]
...
pdf_documents = [
    ('Index', 'static_info_tables_it', u'Static Info Tables (it)',
     u'Franz Holzinger'),
]
...
texinfo_documents = [
    ('Index', 'static_info_tables_it', u'Static Info Tables (it)',
     u'Franz Holzinger', 'Static Info Tables (it)', 'One line description of project.',
     'Miscellaneous'),
]
